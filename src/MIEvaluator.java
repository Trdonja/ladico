...
public class Registrator3D {
    ...
    public Registrator3D(GridFunction3D reference, GridFunction3D target, Transformation3D transformation) {
    ...
    private MutualInformation createMutualInformation(int numberOfSamples) {
        ...
        for (int i = 0; i < numberOfSamples; i++) {
            ...
            final Point3D u = new Point3D(x, y, z);
